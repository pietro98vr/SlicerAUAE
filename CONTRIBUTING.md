...
The segmentation model belongs to the upstream authors; please send model or core
segmentation issues to the upstream repository. Issues and pull requests for this project
features (airway extension, batch processing, island options, dependency preflight) are
welcome here.

Maintainers: Dr. Pietro Montagna (pietro.montagna@univr.it) and Dr. Fabio Lonardi
(fabio.lonardi@univr.it), University of Verona.

The rest of this guide follows the upstream contributing rules.
